...
require('catppuccin').setup({
    ...
    -- Color and highlight overrides copied originally from here:
    -- https://github.com/catppuccin/nvim/discussions/323?sort=top#discussioncomment-12522504
    color_overrides = {
        mocha = COLORS.mocha,
        latte = COLORS.latte,
    },
